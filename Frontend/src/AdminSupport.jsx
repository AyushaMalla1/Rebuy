...
function AdminSupport({ embedded = false }) {
  ...
  const fetchTickets = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/support/admin/tickets?${params}`);
  ...
  const fetchStats = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/support/admin/stats`);
  ...
  const handleUpdateStatus = async (status) => {
    try {
      await axios.patch(`${process.env.REACT_APP_API_URL}/support/admin/tickets/${selectedTicket._id}/status`, {
        status,
        adminId: admin._id
      });
  ...
  const handleUpdatePriority = async (priority) => {
    try {
      await axios.patch(`${process.env.REACT_APP_API_URL}/support/admin/tickets/${selectedTicket._id}/priority`, {
        priority
      });
  ...
  const handleSaveNote = async () => {
    try {
      await axios.patch(`${process.env.REACT_APP_API_URL}/support/admin/tickets/${selectedTicket._id}/note`, {
        note: internalNote
      });
