...
import { FiHeart, FiShoppingCart, FiChevronLeft, FiChevronRight, FiStar, FiTruck, FiRefreshCw, FiMessageSquare, FiAward, FiZap, FiPackage, FiCheck } from 'react-icons/fi';
      ...
      if (product && product._id) {
        try {
          ...
          if (data.success) {
            ...
            const similarMapped = data.products.map(p => ({
              id: p._id,
              name: p.name,
              price: p.price,
  ...
  const handleContactSeller = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Navigate to messages tab in buyer profile
        navigate('/buyer/profile', { 
          state: { 
            ...
            openConversation: {
              ...
              sellerAvatar: product.sellerInfo?.avatar || ''
            }
          } 
        });
      } else {
